...
@section('title', 'Tambah Kelulusan')
...
<div class="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow">
    <h2 class="text-2xl font-bold mb-4">Tambah Kelulusan</h2>

    @if(session('success'))
        <p class="text-green-600 mb-4">{{ session('success') }}</p>
    @endif

    {{-- Cek apakah bisa buat kelulusan baru --}}
    @if(!$canCreateNew)
        <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-4" role="alert">
            <p>Kelulusan sudah ada. Anda harus menghapus kelulusan lama terlebih dahulu sebelum membuat kelulusan baru.</p>
        </div>
    @endif
...
document.getElementById('kelulusanCreateForm').addEventListener('submit', ()=>{
