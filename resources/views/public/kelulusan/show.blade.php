...
@section('title', $kelulusan->judul ?? 'Kelulusan Tidak Ditemukan')
...
<section class="relative w-full h-80 bg-cover bg-center text-white flex items-center justify-center overflow-hidden"
    style="background-image: url('{{ $kelulusan->image ? Storage::url($kelulusan->image) : asset('images/default-banner.jpg') }}');"
    data-aos="fade-in">
    <div class="absolute inset-0 bg-[#344966]/70 z-0"></div>
    <div class="relative z-10 text-center px-4">
        <h1 class="text-3xl md:text-4xl font-bold uppercase mb-2">{{ $kelulusan->judul }}</h1>
        <p class="text-lg md:text-xl">SMK Negeri 1 Subang - Kelulusan</p>
    </div>
</section>
...
@endif
    ...
    @empty
        <p class="text-xl text-red-600 font-semibold text-center">Belum ada konten untuk kelulusan ini.</p>
    @endforelse
